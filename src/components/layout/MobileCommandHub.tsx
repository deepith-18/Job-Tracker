...
const CATEGORIES: CommandCategory[] = [
  ...
  },
  {
    ...
    items: [
      { to: '/about', label: 'About & Credits (Deepith)', icon: <Sparkles size={16} /> },
      { to: '/profile', label: 'Profile & Settings', icon: <Ic d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /> },
      { to: '/diagnostics', label: 'System Diagnostics', icon: <Ic d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /> },
    ],
  },
];
    ...
    <>
      ...
      <div className="mobile-bottom-dock">
        ...
        <button onClick={() => setHubOpen(true)} className="dock-hub-btn" aria-label="Open Launchpad">
          <span className="dock-hub-inner" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <BrandLogo size={26} />
          </span>
        </button>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 11.5, color: '#a5b4fc', fontWeight: 600 }}>
                    Job Orbit • Built by Deepith
                  </div>
                </div>
              </div>
              <button onClick={() => setHubOpen(false)} className="mobile-hub-close" aria-label="Close Launchpad">
